...
fruit_images = [
    pygame.image.load(r"C:\Users\nadjl\apple.png").convert_alpha(),
    pygame.image.load(r"C:\Users\nadjl\banana.png").convert_alpha(),
    pygame.image.load(r"C:\Users\nadjl\strawberry.png").convert_alpha(),
]

# Charger les autres images
bomb_image = pygame.image.load(r"C:\Users\nadjl\bomb.png").convert_alpha()
ice_block_image = pygame.image.load(r"C:\Users\nadjl\ice.png").convert_alpha()


fruit_sound = pygame.mixer.Sound(r"C:\Users\nadjl\knife-slice-.mp3")
ice_sound = pygame.mixer.Sound(r"C:\Users\nadjl\ice_sound (1).mp3")
...
def remove_object(letter):
    global score, combo_multiplicator, last_hit_time, frozen, freeze_end_time
